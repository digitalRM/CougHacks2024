  ...
  return (
    <div className=" max-w-5xl mx-auto mt-5">
      ...
      <div className="mt-2 flex rounded-xl shadow-sm">
        ...
        >
          ...
          <input
            ...
            className="block w-full rounded-none rounded-l-xl border py-3  pl-10 text-gray-900 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
        ...
        <button
          ...
          className="relative -ml-px inline-flex items-center gap-x-1.5 rounded-r-xl px-3 py-2 text-sm font-semibold text-gray-900 border hover:bg-gray-50 disabled:opacity-50 disabled:cursor-wait"
        >
          View Article
        </button>
      </div>
      ...
      <div
        ...
        className="h-0.5 w-full mt-4 mb-2"
      />
      <CustomizeFormat
        backgroundColor={backgroundColor}
